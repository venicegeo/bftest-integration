    ...
    stage ("Geoserver-Int-Health-Check") {
        withCredentials([file(credentialsId: '09e71c41-d5a2-4936-88b2-7b4497cfb1df', variable: 'GEOSERVER')]) {            
          withCredentials([file(credentialsId: '579f8660-01e6-4feb-8764-ec132432ebb1', variable: 'POSTMAN_FILE')]) {   
            ...
            sh "/jslave/workspace/venice/beachfront/health-job/node_modules/newman/bin/newman.js -o results_bf_ia_int.json --requestTimeout 240000 -x -e ./environments/int.postman_environment -g $POSTMAN_FILE  -c ./collections/all/BF-IA-Broker_Daily.postman_collection"     
