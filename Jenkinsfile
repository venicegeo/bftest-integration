  ...
  try {
   ...
   stage ("GeoAxis-Health-Check") {
      withCredentials([file(credentialsId: '0efdaa83-18d6-4513-8a7c-c52ef5b07910', variable: 'GEOAXIS')]) { 
            ...
            sh "/jslave/workspace/venice/beachfront/health-job/node_modules/newman/bin/newman.js  -o results_GeoAxis.json --requestTimeout 240000 -x -e ./ci/Daily/environments/int.postman_environment -g $GEOAXIS -c ./ci/Daily/collections/all/GeoAxis.postman_collection"  
