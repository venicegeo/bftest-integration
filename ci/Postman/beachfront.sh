...
for space in $spaces; do
	...
	cmd="/jslave/workspace/venice/beachfront/bf-ia-broker/4-beachfront_integration_tests/newman -o results.json --requestTimeout 960000 -x -e $envfile -g $POSTMAN_FILE -c"
